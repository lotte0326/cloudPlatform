		  		   ...
		  		   success: function(data){
		  			...
		  			$.each(arrayFileObj,function(n,file){
		  				...
		  				var td_title = $("<td>" + file.title + "</td>")
		  		  		var td_download = $("<td><a href=" + file.fileKey + "\"commonController.do?viewFile&fileid=&subclassname=org.jeecgframework.modules.cgform.entity.upload.CgUploadEntity\" title=\"下载\">下载</a></td>")
		  		  		var td_view = $("<td><a href=\"javascript:void(0);\" onclick=" + file.fileKey + "\"openwindow('预览','commonController.do?openViewFile&fileid=&subclassname=org.jeecgframework.modules.cgform.entity.upload.CgUploadEntity','fList',700,500)\">预览</a></td>");
