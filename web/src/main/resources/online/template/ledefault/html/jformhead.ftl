						...
						<#elseif po.show_type=='file'>
								<table>
									...
									<#list filesList as fileB>
										...
										<td><a style="margin-left:8px;" href="${basePath}/commonController.do?viewFile&fileid=${fileB['fileKey']}&subclassname=org.jeecgframework.modules.cgform.entity.upload.CgUploadEntity" title="下载">下载</a></td>
										<td><a style="margin-left:8px;"  href="javascript:void(0);" onclick="openwindow('预览','${basePath}/commonController.do?openViewFile&fileid=${fileB['fileKey']}&subclassname=org.jeecgframework.modules.cgform.entity.upload.CgUploadEntity','fList',700,500)">预览</a></td>
						...
						<#elseif po.show_type=='image'>
								...
								<#-- update--begin--author:zhangjiaqiang date:20170519 for:修订资源预览关联错误 -->
									<#list imageList as imageB>
										...
										<td>${imageB['title']}</td>
										<#-- update--begin--author:zhangjiaqiang date:20170608 for:增加下载、预览、删除按钮之间的间隔 -->
										<td><a style="margin-left:8px;"  href="${basePath}/commonController.do?viewFile&fileid=${imageB['fileKey']}&subclassname=org.jeecgframework.modules.cgform.entity.upload.CgUploadEntity" title="下载">下载</a></td>
										<td><a style="margin-left:8px;"  href="javascript:void(0);" onclick="openwindow('预览','${basePath}/commonController.do?openViewFile&fileid=${imageB['fileKey']}&subclassname=org.jeecgframework.modules.cgform.entity.upload.CgUploadEntity','fList',700,500)">预览</a></td>
