...
public class SqlUtil {
    ...
    public static String getAllTableSql(String dbType,String ... param){
    	if(StringUtil.isNotEmpty(dbType)){
	    	if(dbType.equals(DATABSE_TYPE_MYSQL)){
	    		return MessageFormat.format(MYSQL_ALLTABLES_SQL, (Object[])param);
    ...
    public static String getAllCloumnSql(String dbType,String ... param){
    	if(StringUtil.isNotEmpty(dbType)){
	    	if(dbType.equals(DATABSE_TYPE_MYSQL)){
	    		return MessageFormat.format(MYSQL_ALLCOLUMNS_SQL, (Object[])param);
	    	}else if(dbType.equals(DATABSE_TYPE_ORACLE)){
	    		return MessageFormat.format(ORACLE_ALLCOLUMNS_SQL, (Object[])param);
	    	}else if(dbType.equals(DATABSE_TYPE_POSTGRE)){
	    		return MessageFormat.format(POSTGRE_ALLCOLUMNS_SQL, (Object[])param);
	    	}else if(dbType.equals(DATABSE_TYPE_SQLSERVER)){
	    		return MessageFormat.format(SQLSERVER_ALLCOLUMNS_SQL, (Object[])param);
	    	}
    	}
    	return null;
    }
