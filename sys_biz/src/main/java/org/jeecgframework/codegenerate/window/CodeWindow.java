                    ...
                    if(!"".equals(entityfld.getText())) {
                        ...
                        if(!"".equals(titlefld.getText())) {
                            ...
                            if(!"".equals(tablefld.getText())) {
                                ...
                                try {
                                    boolean e1 = (new JeecgReadTable()).checkTableExist(CodeWindow.tableName);
                                    if(e1) {
                                        (new CodeGenerate(CodeWindow.entityPackage, CodeWindow.entityName, CodeWindow.tableName,
                                                CodeWindow.ftlDescription, createFileProperty, CodeWindow.fieldRowNum, CodeWindow.primaryKeyPolicy, CodeWindow.sequenceCode)).generateToFile();
                                        showlbl.setForeground(Color.red);
