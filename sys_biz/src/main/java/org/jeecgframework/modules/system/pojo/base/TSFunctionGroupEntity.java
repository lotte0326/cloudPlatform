 ...
 */
@Entity
@Table(name = "t_s_function_group", schema = "")
@SuppressWarnings("serial")
public class TSFunctionGroupEntity implements java.io.Serializable {
	/**ID*/
	private String id;
	/**权限组名称*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  权限组父ID
	 */
