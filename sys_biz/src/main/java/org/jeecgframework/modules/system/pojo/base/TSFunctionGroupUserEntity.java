...
/**   
 * @Title: Entity
 * @Description: 权限组用户关联表
 * @author onlineGenerator
 * @date 2017-08-24 18:50:13
 * @version V1.0   
 *
 */
@Entity
@Table(name = "t_s_function_group_user", schema = "")
@SuppressWarnings("serial")
public class TSFunctionGroupUserEntity implements java.io.Serializable {
	/**ID*/
	private String id;
	/**权限组ID*/
	 ...
	 *@return: java.lang.Integer  权限组类型0/二级管理员,1/普通用户
	 */
