...
public class WxActInviteController extends BaseController {
    ...
    public void list(@ModelAttribute WxActInvite query, HttpServletRequest request, HttpServletResponse response, @RequestParam(required = false,value = "pageNo",defaultValue = "1") int pageNo, @RequestParam(required = false,value = "pageSize",defaultValue = "10") int pageSize) throws Exception {
        try {
            this.LOG.info(request, " back list");
            MiniDaoPage e = this.wxActCommoninviteDao.getAll(query, pageNo, pageSize);
    ...
    public void wxActCommoninviteDetail(@RequestParam(required = true,value = "id") String id, HttpServletResponse response, HttpServletRequest request) throws Exception {
        ...
        WxActInvite wxActCommoninvite = this.wxActCommoninviteDao.get(id);
    ...
    public AjaxJson doAdd(@ModelAttribute WxActInvite wxActCommoninvite) {
        ...
        try {
            ...
            wxActCommoninvite.setId(e);
            this.wxActCommoninviteDao.insert(wxActCommoninvite);
            j.setMsg("保存成功");
    ...
    public AjaxJson doEdit(@ModelAttribute WxActInvite wxActCommoninvite) {
        ...
        try {
            this.wxActCommoninviteDao.update(wxActCommoninvite);
            j.setMsg("编辑成功");
        } catch (Exception var4) {
            var4.printStackTrace();
            j.setSuccess(false);
    ...
    public AjaxJson doDelete(@RequestParam(required = true,value = "id") String id) {
        ...
        try {
            WxActInvite e = new WxActInvite();
            e.setId(id);
            this.wxActCommoninviteDao.delete(e);
            j.setMsg("删除成功");
        } catch (Exception var4) {
            var4.printStackTrace();
            j.setSuccess(false);
